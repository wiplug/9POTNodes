...
struct ResultBuffer{
    ...
    Vector3D LatestPHip;
       ...
       Vector3D fkResult_Hip;

       Vector3D fkResult_LeftWrist;
       Vector3D fkResult_RightWrist;
       Vector3D fkResult_LeftAnkle;
       Vector3D fkResult_RightAnkle;
       ...
       Quaternion Q_LeftThigh;
       Quaternion Q_RightThigh;
...
//    void setupFK();
    ...
    void initResultBuffer(const HumanFK::InitPos& P4FK){
        ...
        resultBuffer.Q_LeftThigh = humanFK.Qinit.Qinit_LeftThigh;
        resultBuffer.Q_RightThigh = humanFK.Qinit.Qinit_RightThigh;
}
